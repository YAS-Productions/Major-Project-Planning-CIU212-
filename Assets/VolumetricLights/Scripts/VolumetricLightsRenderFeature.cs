    ...
    public class VolumetricLightsRenderFeature : ScriptableRendererFeature {
        ...
        class VolumetricLightsRenderPass : ScriptableRenderPass {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
                ...
                VolumetricLight.volumetricLights.Sort(DistanceToCameraComparer);
                    ...
                    if (vl != null && vl.meshRenderer != null) {
                        ...
                        if (vl.meshRenderer.isVisible && (cam.cullingMask & (1 << vl.gameObject.layer)) != 0 && vl.material != null)
                        {
                            if (renderCount++ == 0)
                            {
                                ...
                                cmd.SetRenderTarget(lightBuffer, source);
            ...
            // render far fog volumes first
            int DistanceToCameraComparer(VolumetricLight vl1, VolumetricLight vl2) {
                if (vl2 == null) return -1;
                if (vl1 == null) return 1;
                float dist1 = (vl1.transform.position - currentCameraPosition).sqrMagnitude;
                float dist2 = (vl2.transform.position - currentCameraPosition).sqrMagnitude;
